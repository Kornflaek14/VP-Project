...
public class DelusionalStrikeCard extends AbstractCard {
    public DelusionalStrikeCard() {
        super("DelusionalStrikeCard", "Delusion", 2, "The Patient", 6, 0, "Deal 6 damage, plus 2 for each card containing Strike in your deck.", "cards/Delusion.png", CardType.ATTACK);
    }
    @Override
