...
public class BossRoom extends AbstractRoom {
    ...
    public void onPlayerEntry(CardBattlerGame game) {
        ...
        game.setScreen(new com.cardgame.screens.BattleScreen(game, new com.cardgame.logic.monsters.MonsterGroup(new com.cardgame.logic.monsters.FleshAmalgam(1000f, 280f))));
    }
}
